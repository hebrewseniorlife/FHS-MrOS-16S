...
res_path <- "/n/groups/ifaromics/paul/HRPQCT_16S_Analysis/16S_results/GENUS/FHS/women_only/"

#Load data created on #HSL RStudio
abd <- read.table(file = data_path %&% "O2_FHS_16S_Abd_Genus_Women_Only.txt", 
