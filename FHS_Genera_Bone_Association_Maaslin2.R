...
library(tidyverse)
library(Maaslin2)
#In Maaslin2 The data file can contain samples not included in the metadata file 
#(along with the reverse case). For both cases, those samples not included in both 
#files will be removed from the analysis. Also the samples do not need to be in 
...
res_path <- "/n/groups/ifaromics/paul/HRPQCT_16S_Analysis/16S_results/GENUS/FHS/both_sex/"
